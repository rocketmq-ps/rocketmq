...
package org.apache.rocketmq.exporter.model.brokerruntime;


import org.apache.rocketmq.common.protocol.body.KVTable;
import org.apache.rocketmq.exporter.util.NumberUtils;
...
public class BrokerRuntimeStats {
    ...
    private void loadCommitLogDirCapacity(String commitLogDirCapacity) {
        ...
        this.commitLogDirCapacityTotal = NumberUtils.machineReadableByteCount(total);
        this.commitLogDirCapacityFree = NumberUtils.machineReadableByteCount(free);
    }
